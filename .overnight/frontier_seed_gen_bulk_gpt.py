...
Output:
  ~/swarmops/.overnight/seed_bank_expansion_gpt.jsonl
  ~/swarmops/.overnight/seed_bank_bulk_gpt.log
...
RESULTS_PATH = OUT_DIR / "seed_bank_expansion_gpt.jsonl"
LOG_PATH = OUT_DIR / "seed_bank_bulk_gpt.log"
...
"""
    ...
    result = mcp_call({
        ...
        "reason": f"Bulk seed generation (gpt5.5): {category} batch of {n}",
    })
