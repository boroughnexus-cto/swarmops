...
Output:
  ~/swarmops/.overnight/seed_bank_expansion_sonnet.jsonl
  ~/swarmops/.overnight/seed_bank_bulk_sonnet.log
...
RESULTS_PATH = OUT_DIR / "seed_bank_expansion_sonnet.jsonl"
LOG_PATH = OUT_DIR / "seed_bank_bulk_sonnet.log"
...
"""
    ...
    result = mcp_call({
        ...
        "reason": f"Bulk seed generation (sonnet): {category} batch of {n}",
    })
